  ...
  useEffect(() => {
    async function fetchData() {
      ...
      try {
        ...
        toast.error("Failed to load your leagues and teams");
      } finally {
        setIsLoading(false);
      }
    }
          ...
          <CardContent className="pt-6">
            <div className="text-center space-y-4">
              ...
              <p className="text-muted-foreground max-w-md mx-auto">
                You need to create or join a team before you can participate in leagues.
              </p>
...
export default withAuth(MyLeaguesPage);
